...
I am a **self-taught software engineer and instructor** with over **five years of professional experience in *software development***. I work across web and mobile platforms, with strong expertise in `React.js`, `React Native`, `Node.js`, and `Golang`. My focus is on building reliable, maintainable, and scalable systems that align with both technical requirements and business goals.

I am the **winner of the Republican Olympiad in Informatics (2023–2024 season)**, which reflects a strong command of **data structures, algorithms, and structured problem-solving**. In addition to development work, I contribute to developer growth through **Udemy** courses and **YouTube** content, delivering practical, industry-relevant education designed to support teams, learners, and organizations.

---

### Social Links

[![Website](https://img.shields.io/badge/Website-000000?style=for-the-badge&logo=google-chrome&logoColor=white)](https://huseynovvusal.dev)
...
<img src="https://skills.syvixor.com/api/icons?i=elasticsearch" width="40" height="40" alt="Elasticsearch"/> &nbsp;
<img src="https://skills.syvixor.com/api/icons?i=graphql" width="40" height="40" alt="GraphQL"/> &nbsp;
<img src="https://skills.syvixor.com/api/icons?i=grpc" width="40" height="40" alt="gRPC"/> &nbsp;
<img src="https://skills.syvixor.com/api/icons?i=rabbitmq" width="40" height="40" alt="RabbitMQ"/> &nbsp;
<img src="https://skills.syvixor.com/api/icons?i=docker" width="40" height="40" alt="Docker"/> &nbsp;
<img src="https://skills.syvixor.com/api/icons?i=jest" width="40" height="40" alt="Jest"/> &nbsp;
